...
//        TextView jmlHarga = findViewById(R.id.jumlahHarga);
//
//        final Controller ct = (Controller)getApplicationContext();
//
//        final int CartSize = ct.getOrder().getCartsize();
//
//        String show = "";
//
//        for(int i=0;i<CartSize;i++){
//
//            String pName = ct.getOrder().getProducts(i).getNamaSatay();
//
//            double  pPrice = ct.getOrder().getProducts(i).getHargaSatay();
//
...
//
//
////            show += "Product Name:"+pName+" "+"Price : "+pPrice+"";
//
//
//
//        }
//
//        String tukar = Double.toString(totalHarga);
//        jmlHarga.setText(tukar);
